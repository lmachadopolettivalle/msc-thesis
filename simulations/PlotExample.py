...
OUTPUTS_DIRECTORY = "/cluster/scratch/lmachado/PINOCCHIO_OUTPUTS/luis_runs/"
RUN_NAME = "luis"


(m,nm,fit)=np.loadtxt(OUTPUTS_DIRECTORY+f'pinocchio.0.0000.{RUN_NAME}.mf.out',unpack=True,usecols=(0,1,5))
...
(x,y,z)=np.loadtxt(OUTPUTS_DIRECTORY+f'pinocchio.0.0000.{RUN_NAME}.catalog.out',unpack=True,usecols=(5,6,7))
...
(x,y,z,m)=np.loadtxt(OUTPUTS_DIRECTORY+f'pinocchio.{RUN_NAME}.plc.out',unpack=True,usecols=(2,3,4,8))
