...
outfile_dir = directories.path_interpolation(
...
infile_hist2D_dir = directories.path_histograms(
    particle_count=particle_count_pinocchio,
    z_depth=Z_DEPTH,
    pinocchio_region=PINOCCHIO_REGION,
    DESI_region=region,
...
infile_subhalos_dir = directories.pinocchio_subhalo_files_path(
    particle_count=particle_count_pinocchio,
    z_depth=Z_DEPTH,
    pinocchio_region=PINOCCHIO_REGION,
    DESI_region=region,
...
infile_ucat_sampling_dir = directories.outputs_sampling_path(
    particle_count=particle_count_pinocchio,
    z_depth=Z_DEPTH,
    pinocchio_region=PINOCCHIO_REGION,
    DESI_region=region,
...
print('infile_subhalos_dir = ' + infile_subhalos_dir)
print('infile_hist_red = ' + infile_hist_red)
print('infile_hist_blue = ' + infile_hist_blue)
print('infile_subhalos = ' + infile_subhalos)
